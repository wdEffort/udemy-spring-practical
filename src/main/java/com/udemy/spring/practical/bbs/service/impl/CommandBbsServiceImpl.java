...
import com.udemy.spring.practical.bbs.repository.impl.CommandBbsDAO;
...
public class CommandBbsServiceImpl implements BbsService {
    ...
    public void list(Model model) {
        BbsDAO bbsDAO = new CommandBbsDAO();
